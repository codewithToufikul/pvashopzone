import content from './image/content.webp';
import data from './image/data.webp';
import digital from './image/digital.webp';
import seo from './image/seo.webp';
import social from './image/social.webp';
...
export const Specialist = () => {
  ...
  return (
    <div className="relative min-h-screen   bg-black overflow-hidden">
      ...
      <div className="max-w-[1700px] mt-[-80px] md:mt-8  mx-auto">
        <img
        ...
        <img
          ...
          alt=""
        />
        <h1 className="text-white text-2xl md:text-7xl uppercase font-bold text-center pt-20">
          we create <span className="text-[#87970a]">creative</span> marketing
        </h1>
        <h1 className="text-center text-white pt-5 text-sm md:text-lg w-full sm:w-[80%] mx-auto">
        ...
        <div className="pt-14 flex flex-wrap gap-8 px-4 sm:px-14 justify-center">
          <div
            data-aos="fade-right"
          ...
          >
            ...
            <h1 className="text-white text-xl md:text-2xl pl-4 pt-4 font-bold">
              Engage. Inform. Convert. Effectively.
            </h1>
            <h1 className="text-white text-sm md:text-md pl-4 pt-2">
